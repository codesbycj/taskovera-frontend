        ...
        <>
            ...
            >
                ...
                <div className="hidden lg:block space-x-3">
                    <Link to="/layout" className="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 transition text-white rounded-md active:scale-95">
                        Get started
                    </Link>
                    <Link to="/layout" className="hover:bg-slate-300/20 transition px-6 py-2 border border-slate-400 rounded-md active:scale-95">
                        Login
                    </Link>
                </div>
